...
#define G_CC_TEMPLERP                                                         \
	TEXEL1, TEXEL0, PRIM_LOD_FRAC, TEXEL0, TEXEL1, TEXEL0, PRIM_LOD_FRAC,     \
		TEXEL0
...
#define gdSPDefLights2(ar, ag, ab, r1, g1, b1, x1, y1, z1, r2, g2, b2, x2,    \
					   y2, z2)                                                \
	{                                                                         \
		{ { { ar, ag, ab }, 0, { ar, ag, ab }, 0 } },                         \
		{                                                                     \
...
#define gdSPDefLights3(ar, ag, ab, r1, g1, b1, x1, y1, z1, r2, g2, b2, x2,    \
					   y2, z2, r3, g3, b3, x3, y3, z3)                        \
	{                                                                         \
		{ { { ar, ag, ab }, 0, { ar, ag, ab }, 0 } },                         \
		{                                                                     \
			{ { { r1, g1, b1 }, 0, { r1, g1, b1 }, 0, { x1, y1, z1 }, 0 } },  \
...
#define gdSPDefLights4(ar, ag, ab, r1, g1, b1, x1, y1, z1, r2, g2, b2, x2,    \
					   y2, z2, r3, g3, b3, x3, y3, z3, r4, g4, b4, x4, y4,    \
					   z4)                                                    \
	{                                                                         \
		{ { { ar, ag, ab }, 0, { ar, ag, ab }, 0 } },                         \
		{                                                                     \
...
#define gdSPDefLights5(ar, ag, ab, r1, g1, b1, x1, y1, z1, r2, g2, b2, x2,    \
					   y2, z2, r3, g3, b3, x3, y3, z3, r4, g4, b4, x4, y4,    \
					   z4, r5, g5, b5, x5, y5, z5)                            \
	{                                                                         \
		{ { { ar, ag, ab }, 0, { ar, ag, ab }, 0 } },                         \
		{                                                                     \
			{ { { r1, g1, b1 }, 0, { r1, g1, b1 }, 0, { x1, y1, z1 }, 0 } },  \
...
#define gdSPDefLights6(ar, ag, ab, r1, g1, b1, x1, y1, z1, r2, g2, b2, x2,    \
					   y2, z2, r3, g3, b3, x3, y3, z3, r4, g4, b4, x4, y4,    \
					   z4, r5, g5, b5, x5, y5, z5, r6, g6, b6, x6, y6, z6)    \
	{                                                                         \
		{ { { ar, ag, ab }, 0, { ar, ag, ab }, 0 } },                         \
		{                                                                     \
			{ { { r1, g1, b1 }, 0, { r1, g1, b1 }, 0, { x1, y1, z1 }, 0 } },  \
...
#define gdSPDefLights7(ar, ag, ab, r1, g1, b1, x1, y1, z1, r2, g2, b2, x2,    \
					   y2, z2, r3, g3, b3, x3, y3, z3, r4, g4, b4, x4, y4,    \
					   z4, r5, g5, b5, x5, y5, z5, r6, g6, b6, x6, y6, z6,    \
					   r7, g7, b7, x7, y7, z7)                                \
	{                                                                         \
...
#define gdSPDefLookAt(rightx, righty, rightz, upx, upy, upz)                  \
	{                                                                         \
		{                                                                     \
			...
			{                                                                 \
				{                                                             \
					{ 0, 0x80, 0 }, 0, { 0, 0x80, 0 }, 0, { upx, upy, upz },  \
						0                                                     \
				}                                                             \
			}                                                                 \
		}                                                                     \
...
#define gSPModifyVertex(pkt, vtx, where, val)                                 \
	{                                                                         \
		Gfx* _g = (Gfx*)(pkt);                                                \
		_g->words.w0 = (_SHIFTL(G_MODIFYVTX, 24, 8) | _SHIFTL((where), 16, 8) \
						| _SHIFTL((vtx)*2, 0, 16));                           \
...
#define gSPBranchLessZrg(pkt, dl, vtx, zval, near, far, flag, zmin, zmax)     \
	{                                                                         \
		...
		_g = (Gfx*)(pkt);                                                     \
		_g->words.w0 = (_SHIFTL(G_BRANCH_Z, 24, 8) | _SHIFTL((vtx)*5, 12, 12) \
						| _SHIFTL((vtx)*2, 0, 12));                           \
 ...
 * NOTE: the highest numbered light is always the ambient light (eg if there
 * are 3 directional lights defined: gsSPNumLights(NUMLIGHTS_3), then lights
...
#define gDPSetCombineLERP(pkt, a0, b0, c0, d0, Aa0, Ab0, Ac0, Ad0, a1, b1,    \
						  c1, d1, Aa1, Ab1, Ac1, Ad1)                         \
	{                                                                         \
		Gfx* _g = (Gfx*)(pkt);                                                \
                                                                              \
...
#define gsDPSetCombineLERP(a0, b0, c0, d0, Aa0, Ab0, Ac0, Ad0, a1, b1, c1,    \
						   d1, Aa1, Ab1, Ac1, Ad1)                            \
	{                                                                         \
...
#define gDPLoadTextureBlock(pkt, timg, fmt, siz, width, height, pal, cms,     \
...
#define gDPLoadTextureBlockYuv(pkt, timg, fmt, siz, width, height, pal, cms,  \
	...
	{                                                                         \
		...
		gDPLoadBlock(pkt, G_TX_LOADTILE, 0, 0,                                \
					 ...
					 CALC_DXT(width, siz##_BYTES));                           \
		gDPPipeSync(pkt);                                                     \
		gDPSetTile(pkt, fmt, siz, (((width)*1) + 7) >> 3, 0, G_TX_RENDERTILE, \
...
#define _gDPLoadTextureBlock(pkt, timg, tmem, fmt, siz, width, height, pal,   \
	...
	{                                                                         \
		...
		gDPPipeSync(pkt);                                                     \
		gDPSetTile(pkt, fmt, siz, (((width)*siz##_LINE_BYTES) + 7) >> 3,      \
				   tmem, G_TX_RENDERTILE, pal, cmt, maskt, shiftt, cms,       \
				   masks, shifts);                                            \
		gDPSetTileSize(pkt, G_TX_RENDERTILE, 0, 0,                            \
					   ((width)-1) << G_TEXTURE_IMAGE_FRAC,                   \
					   ((height)-1) << G_TEXTURE_IMAGE_FRAC)                  \
...
#define gsDPLoadTextureBlock(timg, fmt, siz, width, height, pal, cms, cmt,    \
	...
	gsDPSetTextureImage(fmt, siz##_LOAD_BLOCK, 1, timg),                      \
		gsDPSetTile(fmt, siz##_LOAD_BLOCK, 0, 0, G_TX_LOADTILE, 0, cmt,       \
					maskt, shiftt, cms, masks, shifts),                       \
		gsDPLoadSync(),                                                       \
...
#define _gsDPLoadTextureBlockTile(timg, tmem, rtile, fmt, siz, width, height, \
								  pal, cms, cmt, masks, maskt, shifts,        \
								  shiftt)                                     \
                                                                              \
	gsDPSetTextureImage(fmt, siz##_LOAD_BLOCK, 1, timg),                      \
		gsDPSetTile(fmt, siz##_LOAD_BLOCK, 0, tmem, G_TX_LOADTILE, 0, cmt,    \
...
#define gDPLoadTextureBlock_4b(pkt, timg, fmt, width, height, pal, cms, cmt,  \
	...
	{                                                                         \
		...
		gDPSetTile(pkt, fmt, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, cmt,       \
				   maskt, shiftt, cms, masks, shifts);                        \
		gDPLoadSync(pkt);                                                     \
		gDPLoadBlock(pkt, G_TX_LOADTILE, 0, 0,                                \
					 (((width) * (height) + 3) >> 2) - 1,                     \
...
#define gsDPLoadTextureTile(timg, fmt, siz, width, height, uls, ult, lrs,     \
							lrt, pal, cms, cmt, masks, maskt, shifts, shiftt) \
                                                                              \
	gsDPSetTextureImage(fmt, siz, width, timg),                               \
		gsDPSetTile(                                                          \
			fmt, siz, (((((lrs) - (uls) + 1) * siz##_TILE_BYTES) + 7) >> 3),  \
			0, G_TX_LOADTILE, 0, cmt, maskt, shiftt, cms, masks, shifts),     \
		gsDPLoadSync(),                                                       \
...
#define gDPLoadTextureTile_4b(pkt, timg, fmt, width, height, uls, ult, lrs,   \
	...
	{                                                                         \
		...
		gDPPipeSync(pkt);                                                     \
		gDPSetTile(                                                           \
			pkt, fmt, G_IM_SIZ_4b, (((((lrs) - (uls) + 1) >> 1) + 7) >> 3),   \
			0, G_TX_RENDERTILE, pal, cmt, maskt, shiftt, cms, masks, shifts); \
		gDPSetTileSize(pkt, G_TX_RENDERTILE, (uls) << G_TEXTURE_IMAGE_FRAC,   \
					   (ult) << G_TEXTURE_IMAGE_FRAC,                         \
					   (lrs) << G_TEXTURE_IMAGE_FRAC,                         \
...
#define gsDPLoadTextureTile_4b(timg, fmt, width, height, uls, ult, lrs, lrt,  \
	...
	gsDPSetTextureImage(fmt, G_IM_SIZ_8b, ((width) >> 1), timg),              \
		gsDPSetTile(                                                          \
			fmt, G_IM_SIZ_8b, (((((lrs) - (uls) + 1) >> 1) + 7) >> 3), 0,     \
			G_TX_LOADTILE, 0, cmt, maskt, shiftt, cms, masks, shifts),        \
		gsDPLoadSync(),                                                       \
		...
		gsDPPipeSync(),                                                       \
		gsDPSetTile(                                                          \
			fmt, G_IM_SIZ_4b, (((((lrs) - (uls) + 1) >> 1) + 7) >> 3), 0,     \
...
#define gsDPLoadMultiTile_4b(timg, tmem, rtile, fmt, width, height, uls, ult, \
	...
	gsDPSetTextureImage(fmt, G_IM_SIZ_8b, ((width) >> 1), timg),              \
		gsDPSetTile(                                                          \
			fmt, G_IM_SIZ_8b, (((((lrs) - (uls) + 1) >> 1) + 7) >> 3), tmem,  \
			G_TX_LOADTILE, 0, cmt, maskt, shiftt, cms, masks, shifts),        \
		gsDPLoadSync(),                                                       \
		gsDPLoadTile(G_TX_LOADTILE, (uls) << (G_TEXTURE_IMAGE_FRAC - 1),      \
					 (ult) << (G_TEXTURE_IMAGE_FRAC),                         \
...
#define gDPLoadTLUT_pal16(pkt, pal, dram)                                     \
	...
	_gDPLoadTextureBlock(pkt, dram, (256 + (((pal)&0xf) * 16)),               \
						 G_IM_FMT_RGBA, G_IM_SIZ_16b, 4 * 16, 1, pal, 0, 0,   \
						 0, 0, 0, 0)
...
#define gsDPLoadTLUT_pal16(pal, dram)                                         \
	...
	gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, dram),                \
		gsDPTileSync(),                                                       \
		gsDPSetTile(0, 0, 0, (256 + (((pal)&0xf) * 16)), G_TX_LOADTILE, 0, 0, \
					0, 0, 0, 0, 0),                                           \
...
#define gDPLoadTLUT_pal256(pkt, dram)                                         \
                                                                              \
	_gDPLoadTextureBlock(pkt, dram, 256, G_IM_FMT_RGBA, G_IM_SIZ_16b,         \
						 4 * 256, 1, 0, 0, 0, 0, 0, 0, 0)
