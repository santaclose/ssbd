...
#define FTMARIO_SUPERJUMP_TURN_STICK_THRESHOLD                                \
	50 // Minimum stick range required for direction change (velocity)
#define FTMARIO_SUPERJUMP_TURN_MODEL_THRESHOLD                                \
	20 // Minimum stick range required for direction change (model rotation)
#define FTMARIO_SUPERJUMP_AIR_DRIFT                                           \
	0.6F // Aerial drift multiplier during freefall (FallSpecial)
#define FTMARIO_SUPERJUMP_LANDING_LAG                                         \
	0.28F // Divides animation length and rounds it up (7 / 0.28 = 25 frames of
		  // landing lag)
...
#define FTMARIO_TORNADO_VEL_Y_BASE                                            \
	15.0F // Subtract 0.0 or FTMARIO_TORNADO_VEL_Y_TAP based on whether tornado
		  // charge is empty or full, respectively
#define FTMARIO_TORNADO_VEL_Y_TAP                                             \
	22.0F // Y-velocity added per B-tap during Mario Tornado
