...
#define FTLINK_BOOMERANG_SMASH_STICK_MIN                                      \
	56 // Minimum X-Axis range range required for smash input

#define FTLINK_SPINATTACK_SPAWN_JOINT 0
#define FTLINK_SPINATTACK_EXTEND_POS_COUNT 4
#define FTLINK_SPINATTACK_FLAG_SIZE_1                                         \
	0.0F // Size of Spin Attack item hitbox when 0x184 @ ftStruct is 1
#define FTLINK_SPINATTACK_FLAG_SIZE_2                                         \
	120.0F // Size of Spin Attack item hitbox when 0x184 @ ftStruct is 2
#define FTLINK_SPINATTACK_FLAG_SIZE_3                                         \
	100.0F // Size of Spin Attack item hitbox when 0x184 @ ftStruct is 3
#define FTLINK_SPINATTACK_FLAG_SIZE_4                                         \
	80.0F // Size of Spin Attack item hitbox when 0x184 @ ftStruct is 4
...
#define FTLINK_SPINATTACK_FALLSPECIAL_DRIFT                                   \
	0.6F // Aerial drift multiplier once Link enters freefall after aerial Spin
		 // Attack
#define FTLINK_SPINATTACK_LANDING_LAG                                         \
	0.65F // Divide landing animation length by this value
