...
#define FTKIRBY_VACUUM_RELEASE_LAG                                            \
	40 // Automatic lag frames before Inhale can be released
#define FTKIRBY_VACUUM_COPY_STICK_RANGE_MIN                                   \
	-40 // Minimum control stick threshold on Y-axis to get copy ability
#define FTKIRBY_VACUUM_TURN_STICK_RANGE_MIN 28
#define FTKIRBY_VACUUM_THROW_DAMAGE                                           \
	10 // Damage dealt to inhaled victim upon being shot out
#define FTKIRBY_VACUUM_COPY_DAMAGE                                            \
	6 // Damage dealt to inhaled victim upon being copied
...
#define FTKIRBY_FINALCUTTER_BEAM_SPAWN_JOINT                                  \
	0 // Spawn Final Cutter Beam at the position of this bone
#define FTKIRBY_FINALCUTTER_OFF_X                                             \
	200.0F // X-Offset of Final Cutter Beam spawn position
#define FTKIRBY_FINALCUTTER_AIR_ACCEL_MUL                                     \
	0.5F // Multiplies air acceleration during Final Cutter

#define FTKIRBY_STONE_DURATION_MAX                                            \
	160 // Maximum time Kirby can spend in his Stone form
#define FTKIRBY_STONE_DURATION_MIN                                            \
	18 // Minimum time Kirby must spend in his Stone form before he can turn back
#define FTKIRBY_STONE_FALL_VEL -140.0F // Stone terminal velocity in midair
#define FTKIRBY_STONE_SLIDE_ANGLE                                             \
	F_DEG_TO_RAD(25.0F) // Minimum surface angle required to slide? (Radians)
						// (0.43633232F)
...
#define FTKIRBY_STONE_HEALTH_MAX                                              \
	38 // Maximum % damage Kirby can withstand while transformed
#define FTKIRBY_STONE_HEALTH_MID                                              \
	22 // Begin flashing more rapidly when remaining Stone HP is compromised
#define FTKIRBY_STONE_HEALTH_LOW                                              \
	10 // Begin flashing fast when remaining Stone HP is critical
#define FTKIRBY_STONE_COLANIM_ID_HIGH                                         \
	0x33 // Color Animation ID of high-HP Stone
...
#define FTKIRBY_COPYDONKEY_GIANTPUNCH_CHARGE_DAMAGE_MUL                       \
...
#define FTKIRBY_COPYDONKEY_GIANTPUNCH_VEL_MUL                                 \
...
#define FTKIRBY_COPYSAMUS_CHARGE_INT                                          \
...
#define FTKIRBY_COPYSAMUS_CHARGE_RECOIL_BASE                                  \
...
#define FTKIRBY_COPYLINK_BOOMERANG_SPAWN_JOINT                                \
	0 // Spawn Boomerang at the position of this bone
...
#define FTKIRBY_COPYPIKACHU_THUNDERJOLT_SPAWN_ANGLE                           \
	F_DEG_TO_RAD(-45.0F) // -0.7853982F
...
#define FTKIRBY_COPYNESS_PKFIRE_SPARK_ANGLE_AIR                               \
	F_DEG_TO_RAD(-38.0F) // -0.6632251F
#define FTKIRBY_COPYNESS_PKFIRE_SPARK_ANGLE_GROUND                            \
	F_DEG_TO_RAD(-3.6F) // -0.06283185F
