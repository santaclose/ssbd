...
typedef enum ftCommonStatus
{
	...
	ftStatus_Common_MovesetStart, // Start of uh... I don't know a better name
								  // for this.
...
typedef enum ftMotionAttackIndex
{
	...
	ftMotion_AttackIndex_BaseStart, // Start of moves that are part of the
									// character's base moveset
