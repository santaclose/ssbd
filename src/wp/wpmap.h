...
sb32 wpMap_ProcLRWallCheckGround(mpCollData* coll_data, GObj* weapon_gobj,
								 u32 flags);
...
// Unknown
sb32 wpMap_ProcAllCheckGround(mpCollData* coll_data, GObj* weapon_gobj,
							  u32 flags);
...
// Unknown
sb32 wpMap_ProcAllCheckCollEnd(mpCollData* coll_data, GObj* weapon_gobj,
							   u32 flags);
...
sb32 wpMap_CheckCollideAllRebound(GObj* weapon_gobj, u32 check_flags,
