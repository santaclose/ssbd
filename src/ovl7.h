...
typedef struct scTrainingMenu
{
	...
	scTrainingSprites*
		display_label_sprites; // "DAMAGE", "COMBO", "ENEMY", "SPEED" text
	Sprite** display_option_sprites;
	scTrainingSprites*
		menu_label_sprites; // Orange text describing what each option is?
...
// 80190770
u16 D_ovl80190770[] = { 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0004,
...
// 801907B8
intptr_t D_ovl7_801907B8[] = { 0x26C88, 0x26C88, 0x26C88, 0x26C88, 0x26C88,
							   0x26C88, 0x26C88, 0x26C88, 0x26C88 };
...
sb32 (*jtbl_ovl7_801907F0[6])() = { 0x8018d478, 0x8018d518, 0x8018d684,
...
u8 D_ovl7_8019081C[4][2]
	= { { 0x0, 0x0 }, { 0x1, 0x1 }, { 0x0, 0x1 }, { 0x0, 0x3 } };
...
scUnkDataBounds D_ovl7_80190870
	= { 0x80392a00,
		...
		0x803da800,
		0x00000000,
		{ 0, 0, 1, 64, 0, 0, 0, 240, 0, 1, 106, 153 } };
