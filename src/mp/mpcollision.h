...
sb32 mpCollision_GetUDCommon(s32 line_id, Vec3f* object_pos, f32* dist,
							 u32* flags, Vec3f* angle, s32 ud);
sb32 mpCollision_GetUDCommonUp(s32 line_id, Vec3f* object_pos, f32* dist,
							   u32* flags, Vec3f* angle);
sb32 mpCollision_GetUDCommonDown(s32 line_id, Vec3f* object_pos, f32* dist,
								 u32* flags, Vec3f* angle);
sb32 mpCollision_GetLRCommon(s32 line_id, Vec3f* object_pos, f32* arg2,
							 u32* flags, Vec3f* angle, s32 lr);
sb32 mpCollision_GetLRCommonLeft(s32 line_id, Vec3f* object_pos, f32* arg2,
								 u32* flags, Vec3f* angle);
sb32 mpCollision_GetLRCommonRight(s32 line_id, Vec3f* object_pos, f32* arg2,
								  u32* flags, Vec3f* angle);
...
void mpCollision_GetUDAngle(Vec3f* angle, s32 v1x, s32 v1y, s32 v2x, s32 v2y,
							s32 lr);
sb32 mpCollision_CheckGroundSurfaceTilt(s32 v1x, s32 v1y, s32 v2x, s32 v2y,
										f32 d1x, f32 d1y, f32 d2x, f32 d2y,
										f32* dfx, f32* dfy);
sb32 mpCollision_CheckGroundLineCollisionSame(Vec3f* position,
											  Vec3f* translate, Vec3f* ga_last,
											  s32* stand_line_id,
											  u32* stand_coll_flags,
											  Vec3f* angle);
sb32 mpCollision_CheckGroundLineCollisionDiff(Vec3f* position,
											  Vec3f* translate, Vec3f* ga_last,
											  s32* stand_line_id,
											  u32* stand_coll_flags,
											  Vec3f* angle);
sb32 mpCollision_CheckCeilSurfaceTilt(s32 v1x, s32 v1y, s32 v2x, s32 v2y,
									  f32 d1x, f32 d1y, f32 d2x, f32 d2y,
									  f32* dfx, f32* dfy);
sb32 mpCollision_CheckCeilLineCollisionSame(Vec3f* position, Vec3f* translate,
											Vec3f* ga_last, s32* stand_line_id,
											u32* stand_coll_flags,
											Vec3f* angle);
sb32 mpCollision_CheckCeilLineCollisionDiff(Vec3f* position, Vec3f* translate,
											Vec3f* ga_last, s32* stand_line_id,
											u32* stand_coll_flags,
											Vec3f* angle);
sb32 mpCollision_CheckRWallLineCollisionSame(Vec3f* position, Vec3f* translate,
											 Vec3f* ga_last,
											 s32* stand_line_id,
											 u32* stand_coll_flags,
											 Vec3f* angle);
void mpCollision_GetLRAngle(Vec3f* angle, s32 v1x, s32 v1y, s32 v2x, s32 v2y,
							s32 lr);
sb32 mpCollision_CheckRWallSurfaceTilt(s32 v1x, s32 v1y, s32 v2x, s32 v2y,
									   f32 d1x, f32 d1y, f32 d2x, f32 d2y,
									   f32* dfx, f32* dfy);
sb32 mpCollision_CheckRWallLineCollisionDiff(Vec3f* position, Vec3f* translate,
											 Vec3f* ga_last,
											 s32* stand_line_id,
											 u32* stand_coll_flags,
											 Vec3f* angle);
sb32 mpCollision_CheckLRSurfaceFlat(s32 v1x, s32 v1y, s32 vpos_x, f32 vpdist_x,
									f32 vpdist_y, f32 vtdist_x, f32 vtdist_y,
									f32* arg7, f32* arg8);
sb32 mpCollision_CheckLWallLineCollisionSame(Vec3f* position, Vec3f* translate,
											 Vec3f* ga_last,
											 s32* stand_line_id,
											 u32* stand_coll_flags,
											 Vec3f* angle);
sb32 mpCollision_CheckLWallSurfaceTilt(s32 v1x, s32 v1y, s32 v2x, s32 v2y,
									   f32 d1x, f32 d1y, f32 d2x, f32 d2y,
									   f32* dfx, f32* dfy);
sb32 mpCollision_CheckLWallLineCollisionDiff(Vec3f* position, Vec3f* translate,
											 Vec3f* ga_last,
											 s32* stand_line_id,
											 u32* stand_coll_flags,
											 Vec3f* angle);
sb32 func_ovl2_800F8FFC(Vec3f* position);
sb32 func_ovl2_800F9348(Vec3f* position, s32* project_line_id, f32* ga_dist,
						u32* stand_coll_flags, Vec3f* angle);
sb32 func_ovl2_800F97BC(Vec3f* position, s32* project_line_id, f32* ga_dist,
						u32* stand_coll_flags, Vec3f* angle);
sb32 func_ovl2_800F9C30(Vec3f* position, s32* project_line_id, f32* ga_dist,
						u32* stand_coll_flags, Vec3f* angle);
sb32 func_ovl2_800FA0A4(Vec3f* position, s32* project_line_id, f32* ga_dist,
						u32* stand_coll_flags, Vec3f* angle);
