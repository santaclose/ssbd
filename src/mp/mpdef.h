...
typedef enum mpMaterial
{
	...
	mpCollision_Material_Detect, // Board the Platforms / Race to the Finish
...
typedef enum mpMPointKind
{
	...
	mpMPoint_Kind_BattlePlayer1Spawn
	= mpMPoint_Kind_BattlePlayerSpawnStart, // 0x0
	...
	mpMPoint_Kind_1PGameAlly1Spawn
	= mpMPoint_Kind_1PGameAllySpawnStart,							   // 0x22
