...
GfxColor dMnBattleUnusedColors[4] = { // 8013B68C[4]
	{ 0xFF, 0x7E, 0x7E },
	{ 0xB3, 0xB3, 0xFF },
	{ 0xEB, 0xDB, 0x7A },
	{ 0x96, 0xCC, 0x96 }
...
GfxColor dMnBattleTitleColors[2] = { // 8013B764[2]; // title colors
	{ 0xE3, 0xAC, 0x04 },
	{ 0x61, 0xAD, 0x49 }
};
GfxColorPair dMnBattleCursorTypeColors[4] = { // 8013B76C[4]; // cursor
...
GfxColor dMnBattleTitleColorsDuplicate[2] = { // 8013B7D0[2]; // ffa/team battle colors
	{ 0xe3, 0xac, 0x04 },
	{ 0x61, 0xad, 0x49 }
};
...
scRuntimeInfo D_ovl26_8013B99C
	= { 0x00000000,
		...
		0x00000000,
		{
			00,	  0x00, 0x00, 0x01, 00,	  0x00, 0x00, 0x02, 00,	  0x00, 0x55, 0xF0, 00,	  0x00, 0x02, 0x00, 00,	  0x00,
			0x00, 0x00, 00,	  0x00, 0x00, 0x00, 00,	  0x00, 0x3A, 0x98, 00,	  0x02, 0x00, 0x00, 00,	  0x00, 0x80, 0x00,
		},
		0x80131B20,
		0x80004310,
		{ 00, 00, 00, 0x00, 00, 00, 02, 0x00, 00, 00, 00, 0x00, 00, 00, 00, 0x00,
		  00, 00, 00, 0x00, 00, 00, 00, 0x00, 00, 00, 00, 0x88, 00, 00, 00, 0x00 },
		0x800D5CAC,
		{ 00, 00,	00, 0x00, 00, 00,	00, 0x00, 00, 00,	00, 0x00, 00, 00,	00, 0x00, 00, 00,
