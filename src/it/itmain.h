...
// Remove item from player - this is more than likely not included as Link's
// bomb erroneously calls this without initializing stat_flags and stat_count
// void itMain_SetFighterRelease(GObj *item_gobj, Vec3f *vel, f32 stale, u16
...
// Some basic item subaction event? Updates hitbox damage, size and angle;
// it_multi acts as asynchronous timer
