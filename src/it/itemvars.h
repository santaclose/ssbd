...
#define ITSTAR_INTERACT_DELAY                                                 \
	16 // Wait this many frames before becoming tangible
#define ITSTAR_GRAVITY 1.2F
#define ITSTAR_T_VEL 100.0F
#define ITSTAR_VEL_X 8.0F
#define ITSTAR_BOUNCE_Y                                                       \
	50.0F // Y-velocity added when Star Man touches the ground
...
#define ITHAMMER_WEAR_COLANIM_ID                                              \
	0x4E // Color animation applied to hammer when time is almost up
...
#define ITBOMBHEI_WALK_WAIT                                                   \
	180 // Number of frames required to pass for Bob-Omb to begin walking
#define ITBOMBHEI_FLASH_WAIT                                                  \
	480 // Number of frames required to pass for Bob-Omb to begin flashing
...
#define ITGSHELL_DAMAGE_ALL_WAIT                                              \
	32 // Wait this many frames before shell can damage its owner and teammates
...
#define ITGSHELL_REBOUND_VEL_Y                                                \
	38.0F // Y-velocity gained when recoiling from hitting a target
#define ITGSHELL_STOP_VEL_X                                                   \
	12.0F // Halt all horizontal velocity if less than this value
...
#define ITCONTAINER_GFX_COUNT                                                 \
	7 // Number of pieces Barrel and Crate containers burst into when smashed
	  // open
#define ITCONTAINER_GFX_LIFETIME                                              \
	90 // Smashed container pieces despawn once this runs out
...
#define ITTARU_MIN_VEL_XY                                                     \
	0.1F // Decrement lifetime if Barrel's XY velocity is less than this value
...
#define ITBUMPER_CASTLE_KNOCKBACK                                             \
	300 // Weight-Dependent Set Knockback of Bumper on Peach's Castle
#define ITBUMPER_CASTLE_ANGLE                                                 \
	361 // Knockback angle of Bumper on Peach's Castle
...
#define ITBUMPER_HIT_SCALE                                                    \
	10 // Initial of bumper when hitting a target while airborne
#define ITBUMPER_HIT_ANIM_LENGTH                                              \
	3 // Number of frames bumper's airborne hit texture lasts
#define ITBUMPER_COLL_SIZE 120.0F
#define ITBUMPER_REBOUND_VEL_X                                                \
	(-100.0F) // Applied when bumper hits a target while grounded
#define ITBUMPER_REBOUND_AIR_X                                                \
	(-400.0F) // Applied when bumper hits a target while airborne
#define ITBUMPER_REBOUND_AIR_Y                                                \
	200.0F // Applied when bumper hits a target while airborne
...
#define ITGRLUCKY_EGG_SPAWN_ADD_X                                             \
	8.0F // Added to mutliplied random velocity of egg
#define ITGRLUCKY_EGG_SPAWN_ADD_Y                                             \
	30.0F // Added to multiplide random velocity of egg
#define ITGRLUCKY_EGG_SPAWN_BEGIN                                             \
	80.0F // First frame egg spawn function is called
#define ITGRLUCKY_EGG_SPAWN_END                                               \
	85.0F // Last frame egg spawn function is called
...
#define ITMBALL_SPAWN_WAIT                                                    \
	30 // Wait this many frames before releasing Pokémon once thrown and landed
...
#define ITMONSTER_RISE_VEL_Y                                                  \
	16.0F // Y-velocity of "levitate" effect after exiting Poké Ball

#define ITPAKKUN_APPEAR_WAIT                                                  \
	180 // Duration Pirahna Plant waits before coming out of its pipe
...
#define ITIWARK_ROCK_RUMBLE_WAIT                                              \
	18 // Frames to wait between screen shake effects
#define ITIWARK_ROCK_SPAWN_COUNT_RANDOM                                       \
	9 // Maximum number of rocks that can be spawned
#define ITIWARK_ROCK_SPAWN_COUNT_MIN                                          \
	8 // Added to number of rocks that can be spawned
#define ITIWARK_ROCK_SPAWN_WAIT_MAX                                           \
	30 // Maximum random delay between spawned rocks
#define ITIWARK_ROCK_SPAWN_WAIT_MIN                                           \
	15 // Added to random delay between spawned rocks
#define ITIWARK_ROCK_SPAWN_OFF_X_MUL                                          \
	2000.0F // Multiplies random spawn position of rock projectile
#define ITIWARK_ROCK_SPAWN_OFF_X_ADD                                          \
	(-1000.0F) // Added to random spawn position of rock projectile
#define ITIWARK_FLY_VEL_Y 80.0F // Y-velocity of Onix when flying up
#define ITIWARK_FLY_STOP_Y                                                    \
	200.0F // Stop this many units away from the upper blast zone
#define ITIWARK_IWARK_ADD_POS_Y                                               \
	(-660.0F) // Add this to Y-position if user is Onix
#define ITIWARK_OTHER_ADD_POS_Y                                               \
	(-100.0F) // Add this to Y-position if user is not Onix

#define WPIWARK_ROCK_RANDOM_VEL_MAX                                           \
	3 // Maximum number of random initial Y-velocities possible
...
#define WPIWARK_ROCK_VEL_Y_START_A                                            \
	(-100.0F) // One of three random initial Y-velocities possible
#define WPIWARK_ROCK_VEL_Y_START_B                                            \
	(-50.0F) // One of three random initial Y-velocities possible
#define WPIWARK_ROCK_VEL_Y_START_C                                            \
	0.0F // One of three random initial Y-velocities possible
#define WPIWARK_ROCK_COLLIDE_MUL_VEL_Y                                        \
	0.1F // Assume this is what slows the rocks down so much when they hit the
		 // ground
#define WPIWARK_ROCK_COLLIDE_ADD_VEL_Y                                        \
	(-150.0F) // Added when rock collides with ground
...
#define ITKABIGON_DROP_WAIT                                                   \
	60 // Wait this many frames before dropping after reaching the top of the
	   // screen
#define ITKABIGON_RUMBLE_WAIT                                                 \
	18 // Wait this many frames between screen shake effects
...
#define ITKABIGON_DROP_OFF_X_ADD                                              \
	(-1000.0F) // Added to multiplied random drop X-position
#define ITKABIGON_DROP_SIZE_KABIGON                                           \
	4.0F // Size of Snorlax's drop model and hitbox
#define ITKABIGON_DROP_SIZE_OTHER                                             \
	5.2F // Size of non-Snorlax drop model and hitbox (Clefairy)
#define ITKABIGON_JUMP_VEL_Y 80.0F // Y-velocity of Snorlax's jump
#define ITKABIGON_JUMP_GFX_MUL_OFF                                            \
	200.0F // Multiplies random spawn position of dust GFX when Snorlax jumps
...
#define ITTOSAKINTO_FLAP_VEL_X                                                \
	10.0F // Semi-constant horizontal velocity that may randomly be inverted
#define ITTOSAKINTO_FLAP_VEL_Y                                                \
	60.0F // Vertical velocity gained from touching the ground
...
#define ITNYARS_MODEL_ROTATE_WAIT                                             \
	30 // Flip Meowth's model every time this timer runs out; reset at 0
#define ITNYARS_COIN_SPAWN_MAX 4 // Spawn this many coins simultaneously
#define ITNYARS_COIN_LIFETIME 10
#define ITNYARS_COIN_SPAWN_WAIT                                               \
	8 // Spawn a new set of coins at this frequency (frames)
#define ITNYARS_COIN_ANGLE_STEP                                               \
	13.0F // Multiplies coin rotation step, actually angle in degrees
#define ITNYARS_COIN_ANGLE_DIFF                                               \
	90.0F // Angle difference between each simultaneously spawned coin
#define ITNYARS_COIN_VEL_X 130.0F

#define ITLIZARDON_LIFETIME 480
#define ITLIZARDON_FLAME_LIFETIME 30
#define ITLIZARDON_FLAME_SPAWN_WAIT                                           \
	8 // Wait this many frames before spawning another flame projectile
#define ITLIZARDON_TURN_WAIT                                                  \
	26 // Wait this many frames before flipping Charizard's sprite
#define ITLIZARDON_FLAME_SPAWN_ANGLE                                          \
	F_DEG_TO_RAD(                                                             \
		-15.0F) // Angle at which flame projectile spreads (-0.2617994F)
#define ITLIZARDON_FLAME_VEL_XY 50.0F
#define ITLIZARDON_LIZARDON_FLAME_OFF_X                                       \
	180.0F // X-offset of Charizard's flame spawn position
#define ITLIZARDON_LIZARDON_FLAME_OFF_Y                                       \
	120.0F // Y-offset of Charizard's flame spawn position
#define ITLIZARDON_OTHER_FLAME_OFF_X                                          \
	100.0F // X-offset of other flame spawn position (Clefairy)
#define ITLIZARDON_DUST_GFX_OFF_X                                             \
	(-400.0F) // X-offset of dust GFX when turning around
...
#define ITSPEAR_SPAWN_WAIT_CONST                                              \
	12 // Minimum number of frames between Beedrill swarm member spawns
#define ITSPEAR_SPAWN_WAIT_RANDOM                                             \
	9 // Added to minimum number of frames between Beedrill swarm member spawns
#define ITSPEAR_SPAWN_OFF_Y_MUL                                               \
	1800.0F // Multiplies random vertical spawn position
#define ITSPEAR_SPAWN_OFF_Y_ADD                                               \
	(-800.0F) // Added to random vertical spawn position
...
#define ITKAMEX_HYDRO_SPAWN_WAIT_CONST                                        \
	30 // Constant wait frames to spawn Hydro Pump
#define ITKAMEX_HYDRO_SPAWN_WAIT_RANDOM                                       \
	1 // Maximum random wait frames to spawn Hydro Pump
#define ITKAMEX_KAMEX_HYDRO_SPAWN_OFF_X                                       \
	360.0F // X-offset of Blastoise Hydro Pump spawn position
#define ITKAMEX_KAMEX_HYDRO_SPAWN_OFF_Y                                       \
	100.0F // Y-offset of Blastoise Hydro Pump spawn position
#define ITKAMEX_OTHER_HYDRO_SPAWN_OFF_X                                       \
	100.0F // X-offset of other Hydro Pump spawn position (Clefairy)
...
#define ITMBLUCKY_LIFETIME                                                    \
	90 // Used only after Chansey has spawned all of its eggs
...
#define ITMBLUCKY_EGG_SPAWN_ADD_VEL_X                                         \
	7.0F // Added to multiplied random X-velocity
#define ITMBLUCKY_EGG_SPAWN_ADD_VEL_Y                                         \
	40.0F // Added to multiplide random Y-velocity
#define ITMBLUCKY_GRAVITY 1.0F
#define ITMBLUCKY_T_VEL 40.0F

#define ITEGG_EXPLODE_GFX_WAIT                                                \
	8 // Wait this many frames before spawning eggshell break GFX on explosion
...
#define ITSTARMIE_SWIFT_SPAWN_WAIT_CONST                                      \
	12 // Constant wait frames to spawn Hydro Pump
#define ITSTARMIE_SWIFT_SPAWN_WAIT_RANDOM                                     \
	1 // Maximum random wait frames to spawn Swift
#define ITSTARMIE_SWIFT_VEL_X 150.0F
#define ITSTARMIE_STARMIE_SWIFT_SPAWN_OFF_X                                   \
	200.0F // X-offset of Starmie Swift spawn position
#define ITSTARMIE_STARMIE_SWIFT_SPAWN_OFF_Y                                   \
	100.0F // Y-offset of Starmie Swift spawn position
#define ITSTARMIE_OTHER_SWIFT_SPAWN_OFF_X                                     \
	100.0F // X-offset of other Swift spawn position (Clefairy)
#define ITSTARMIE_TARGET_POS_OFF_X                                            \
	400.0F // Added to Starmie's target travel position + fighter's collision box
#define ITSTARMIE_TARGET_POS_OFF_Y                                            \
	250.0F // Added to Starmie's target travel position + fighter's collision box
#define ITSTARMIE_FOLLOW_VEL_X                                                \
	20.0F // X-velocity at which Starmie follows its victim
...
#define ITDOGAS_DESPAWN_WAIT                                                  \
	90 // Wait this many frames after running out of gas before despawning
...
#define ITDOGAS_SMOG_SUB_OFF_X                                                \
	200.0F // Subtracted from multiplied random spawn position
#define ITDOGAS_SMOG_MUL_OFF_Y 800.0F // Multiply random spawn position
#define ATDGOAS_SMOG_SUB_OFF_Y                                                \
	400.0F // Subtracted from multiplied random spawn position

#define ITMARUMINE_EXPLODE_LIFETIME 6
#define ITMARUMINE_EXPLODE_GFX_SCALE 1.4F

#define ITPORYGON_SHAKE_STOP_WAIT                                             \
	32 // Stop vertical shake after this many frames have passed?
...
#define ITHITOKAGE_FLAME_SPAWN_BEGIN                                          \
	40.0F // Charmander can begin firing Flamethrower this frame onward
#define ITHITOKAGE_FLAME_SPAWN_END                                            \
	120.0F // Charmander can no longer fire Flamethrower this frame onward
...
#define ITHITOKAGE_NDAMAGE_KNOCKBACK_MIN                                      \
	100.0F // Minimum knockback required to send Charmander into damage state
#define ITHITOKAGE_GRAVITY 1.2F
#define ITHITOKAGE_T_VEL 100.0F

#define ITFUSHIGIBANA_RETURN_WAIT                                             \
	128 // Wait this many frames before deactivating hitbox?
...
#define ITFUSHIGIBANA_RAZOR_SPAWN_BEGIN                                       \
	40.0F // Venusaur can begin shooting Razor Leaf this frame onward
#define ITFUSHIGIBANA_RAZOR_SPAWN_END                                         \
	120.0F // Venusaur can no longer shoot Razor Leaf this frame onward
#define ITFUSHIGIBANA_RAZOR_SPAWN_OFF_X (-540.0F) // X-offset of leaf spawn

#define ITRBOMB_GFX_COUNT                                                     \
	7 // Number of pieces RTTF Bomb bursts into when smashed open
#define ITRBOMB_GFX_LIFETIME                                                  \
	90 // Smashed RTTF Bomb pieces despawn once this runs out
...
#define ITPKFIRE_HURT_DAMAGE_MUL                                              \
	3 // Multiplies damage taken, result gets subtracted from lifetime
...
#define ITLINKBOMB_BLOAT_COLANIM_ID                                           \
	0x4F // Apply this color animation when Bomb begins to bloat
#define ITLINKBOMB_BLOAT_COLANIM_LENGTH 96 // Duration of bloat color animation
#define ITLINKBOMB_SCALE_INDEX_MAX                                            \
	10 // Maximum number of scale floats in array?
...
#define ITLINKBOMB_EXPLODE_THRESHOLD_VEL_Y                                    \
	25.0F // If Y-velocity is greater than this value when hitting a target,
		  // explode
#define ITLINKBOMB_BLOAT_BEGIN                                                \
	96.0F // Bomb begins bloating when lifetime is equal or less than this value
#define ITLINKBOMB_HIT_RECOIL_VEL_X                                           \
	8.0F // X-velocity upon hitting a target without exploding
#define ITLINKBOMB_HIT_RECOIL_VEL_Y                                           \
	20.0F // Y-velocity upon hitting a target without exploding
...
#define ITYCITYMONSTER_WEAPON_ALL                                             \
	(ITYCITYMONSTER_WEAPON_INSTANT | ITYCITYMONSTER_WEAPON_WAIT)
