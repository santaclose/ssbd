...
void func_ovl0_800CCF00(GObj *interface_gobj, s32 damage);
...
// 	sobj = func_ovl0_800CCFDC(interface_gobj, gTrainingModeStruct.display_option_sprites[SCTRAINING_STATDISPLAY_CHARACTER_COUNT - 1]);
...
// 	}
// 	func_ovl0_800CCF00(interface_gobj, 0);
// }
...
// 	sobj = func_ovl0_800CCFDC(interface_gobj, gTrainingModeStruct.menu_option_sprites[scTrainingMenu_OptionSprite_Cursor]);
// 	sobj->pos.x = 71.0F;
